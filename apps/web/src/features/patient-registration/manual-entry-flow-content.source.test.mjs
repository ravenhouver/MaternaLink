...
assert.ok(source.includes("const manualStages: ManualStage[] = ['manual-personal', 'pregnancy', 'screening']"), 'manual input uses the direct registration stages');
assert.ok(pregnancyPanel.includes('I. PREGNANCY IDENTITY'), 'step 2 keeps the pregnancy identity section');
